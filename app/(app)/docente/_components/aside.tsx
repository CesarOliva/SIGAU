...
const Sidebar = () => {
    ...
    return (
        <aside id="sidebar" className={`${pathname === "/docente" ? "hidden" : "w-70"} bg-white border-r border-neutral-200 flex flex-col min-h-screen shrink-0 transition-all duration-300`}>
            ...
            <div className="flex-1 overflow-y-auto py-6 px-6 flex flex-col gap-2">
                ...
                <Link href="/docente/carga-academica" className={`flex items-center gap-3 px-4 py-3 rounded-xl ${pathname === '/docente/carga-academica' ? 'bg-orange-50 text-neutral-900' : 'text-neutral-600'} hover:bg-orange-50 hover:text-neutral-900 font-medium transition-colors`}>
                    <Grid2X2 className="w-5"/>
                    <span>Carga académica</span>
                </Link> 
                <Link href="/docente/datos-personales" className={`flex items-center gap-3 px-4 py-3 rounded-xl ${pathname === '/docente/datos-personales' ? 'bg-orange-50 text-neutral-900' : 'text-neutral-600'} hover:bg-orange-50 hover:text-neutral-900 font-medium transition-colors`}>
                    <User className="w-5"/>
                    <span>Datos Personales</span>
                </Link>
                <Link href="/docente/generar-reportes" className={`flex items-center gap-3 px-4 py-3 rounded-xl ${pathname === '/docente/generar-reportes' ? 'bg-orange-50 text-neutral-900' : 'text-neutral-600'} hover:bg-orange-50 hover:text-neutral-900 font-medium transition-colors`}>
