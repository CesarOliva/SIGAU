         ...
         <main className="p-6 flex justify-center items-center h-[80vh]">
            <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-4xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <Link href='/docente/carga-academica' className="bg-neutral-100 hover:bg-orange-50 transition rounded-xl p-6 text-left shadow cursor-pointer">
                        <h3 className="text-lg font-bold text-neutral-800">Carga académica</h3>
                    </Link>
                    
                    <Link href='/docente/datos-personales' className="bg-neutral-100 hover:bg-orange-50 transition rounded-xl p-6 text-left shadow cursor-pointer">
                        <h3 className="text-lg font-bold text-neutral-800">Datos personales</h3>
                    </Link>

                    <Link href='/docente/generar-reportes' className="bg-neutral-100 hover:bg-orange-50 transition rounded-xl p-6 text-left shadow cursor-pointer">
