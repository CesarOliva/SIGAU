...
const UsuariosPage = () => {
    ...
    const validateEditDraft = () => {
        ...
        if (Number.isNaN(Number(editDraft.id))) return 'El num_control debe ser numérico';
        if (editDraft.rol === 'alumno' && editDraft.semestre && Number.isNaN(Number(editDraft.semestre))) return 'Semestre debe ser numérico';
        if (editDraft.rol === 'alumno' && editDraft.carrera && Number.isNaN(Number(editDraft.carrera))) return 'Carrera debe ser numérica';
    ...
    const handleSaveEdit = async () => {
        ...
        if (validationError || !editDraft) {
            setError(validationError || 'No hay usuario en edición');
            return;
        }
